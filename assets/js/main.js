...
appCache.update(); // Attempt to update the user's cache.
  ...
  (function() {
    ...
    if (appCache.status == window.applicationCache.UNCACHED) {
      ...
      var element = $(".navigation-wrapper .masthead #main .footer-wrapper").addClass( "wf-loading" );
...
$(document).ready(function() {
  ...
  $( "#loading").remove();
  if(navigator.onLine){}else{$( "#myBtn, .btn.twitter, .btn.facebook, .dsq-brlink, .social-span-class").remove();}
